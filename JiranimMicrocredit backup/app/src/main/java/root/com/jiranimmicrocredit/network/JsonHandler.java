...
public class JsonHandler {
    ...
    private String requestUrl=" http://www.origicheck.com/jiranimicrocredit/implementation.php";
    ...
    public JSONObject JsonConnection(ContentValues postDataParams) throws IOException,UnknownHostException {
