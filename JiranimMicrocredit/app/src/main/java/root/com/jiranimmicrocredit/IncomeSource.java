 ...
 */
public class IncomeSource extends AppCompatActivity implements Property.CallBackInterface,Employment.CallEmpBackInterface,OtherOccupations.CallOtherBackInterface {
    ...
    public static IncomeSource  context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.income_tablayout);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Property(), "Property");
        adapter.addFragment(new Employment(), "Employment");
        adapter.addFragment(new OtherOccupations(), "Others");
    ...
    public void ButtonPressed(int id,int crop,int from) {
        ...
        switch (id) {
            ...
            case 2:
                ...
                AlertDialog.Builder imgbuilder = new AlertDialog.Builder(IncomeSource.this);
            ...
            case 4:
                try {
                    ...
                    startActivityForResult(mapbuilder.build(IncomeSource.this), PLACE_PICKER_REQUEST);
    ...
    public void passdOtherData(String occupationname, String description, String income) {
        if(NetworkUtils.getConnectivityStatusString(this).equalsIgnoreCase("Wifi Enabled")||NetworkUtils.getConnectivityStatusString(context).equalsIgnoreCase("mobile data Enabled")||Constants.ConnectionStatus.equalsIgnoreCase("Wifi Enabled")||Constants.ConnectionStatus.equalsIgnoreCase("mobile data Enabled")) {
            ...
            extras=new String[] {occupationname,income,description, String.valueOf(userid)};
            new FileTransfer("others", "Uploading files...",Constants.TABLE_OTHEROCCUPATION,extras, this).execute(imagePath).getStatus();
    ...
    public void passdEmpData(String employeename, String department, String period, String email, String income, String selected) {
        if(NetworkUtils.getConnectivityStatusString(this).equalsIgnoreCase("Wifi Enabled")||NetworkUtils.getConnectivityStatusString(context).equalsIgnoreCase("mobile data Enabled")||Constants.ConnectionStatus.equalsIgnoreCase("Wifi Enabled")||Constants.ConnectionStatus.equalsIgnoreCase("mobile data Enabled")) {
            ...
            userid=1;
            location="none";
            extras=new String[] {String.valueOf(userid),employeename,department,location,selected,period,income};
            new FileTransfer("employment", "Uploading files...",Constants.TABLE_EMPLOYMENT,extras, this).execute(imagePath).getStatus();
    ...
    public void passdData(String propertyname, String location, String plotnumber, String Occupancy, String income,String ownership) {
        ...
        if(NetworkUtils.getConnectivityStatusString(this).equalsIgnoreCase("Wifi Enabled")||NetworkUtils.getConnectivityStatusString(context).equalsIgnoreCase("mobile data Enabled")||Constants.ConnectionStatus.equalsIgnoreCase("Wifi Enabled")||Constants.ConnectionStatus.equalsIgnoreCase("mobile data Enabled")) {
            ...
            extras=new String[] {location,propertyname,plotnumber,ownership,Occupancy,income, String.valueOf(userid)};
            new FileTransfer("property", "Uploading files...",Constants.TABLE_PROPERTY,extras, this).execute(imagePath).getStatus();
    ...
    private  static File getOutputMediaFile(int type){
        ...
        if(type==MEDIA_TYPE_IMAGE){
            ...
            mediafile =new  File(mediaStorageDir.getPath() + File.separator + "JIRANI_MICRO_CREDIT"+ timestamp + ".jpg" );
            imageFilename = "JIRANI_MICRO_CREDIT"+ timestamp + ".jpg";

        }
        else if(type==MEDIA_TYPE_VIDEO){

            mediafile =new  File(mediaStorageDir.getPath() + File.separator + "JIRANI_MICRO_CREDIT"+ timestamp + ".mp4" );
            videoFilename="JIRANI_MICRO_CREDIT"+ timestamp + ".mp4";
        } else{
    ...
    public void onActivityResult(int requestCode,int resultCode, Intent data){
        ...
        if(requestCode ==CAPTURE_IMAGE_CROP_ACTIVITY){
            ...
            if (resultCode == RESULT_OK) {
                ...
                pref.edit().putString(Constants.PROPERTY_LOCATION,place.getName().toString()).commit();
                // Toast.makeText(this, toastMsg + "  Latlong" + Lat.toString(), Toast.LENGTH_LONG).show();
            }
        }
