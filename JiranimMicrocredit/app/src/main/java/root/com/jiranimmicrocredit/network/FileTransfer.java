        ...
        if(result==200 && response==1) {
           ...
           // // message="File Uploaded successfully";
                ...
                if(tablename.equalsIgnoreCase(Constants.TABLE_PROPERTY)){
                    if(NetworkUtils.getConnectivityStatusString(context).equalsIgnoreCase("Wifi Enabled")||NetworkUtils.getConnectivityStatusString(context).equalsIgnoreCase("mobile data Enabled")|| Constants.ConnectionStatus.equalsIgnoreCase("Wifi Enabled")||Constants.ConnectionStatus.equalsIgnoreCase("mobile data Enabled")) {
                        ...
                        Toast.makeText(context, Constants.CONNECTION_FAILED, Toast.LENGTH_SHORT).show();
                    }
