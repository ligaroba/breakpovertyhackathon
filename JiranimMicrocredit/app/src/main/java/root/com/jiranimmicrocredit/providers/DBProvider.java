...
public class DBProvider extends ContentProvider{
    ...
    private static final int LOANPAID=1200;
    private static final int LOANPAIDID=1201;
  ...
  static {
      ...
      matcher.addURI(DBContract.CONTENT_AUTHORITY,DBContract.PATH_LOAN_PAYMENT,LOANPAID);
      matcher.addURI(DBContract.CONTENT_AUTHORITY,DBContract.PATH_LOAN_PAYMENT+"/#",LOANPAIDID);
  }
        ...
        switch (match) {
           ...
           case BUSINESSTYPE:
            ...
            case LOANPAID:
                ...
                rowinserted=db.insert(DBContract.LoanPaid.LOANPAYMENT_TABLE,null,values);
                _uri= ContentUris.withAppendedId(DBContract.LoanPaid.CONTENT_URI, rowinserted);
                getContext().getContentResolver().notifyChange(_uri, null);
                return _uri;
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (match) {
            ...
            case LOANPAID:
                sqlBuilder.setTables(DBContract.LoanPaid.LOANPAYMENT_TABLE);
                cursor = sqlBuilder.query(db, projection, selection, selectionArgs, sortOrder, null, null, null);
                cursor.setNotificationUri(getContext().getContentResolver(), uri);
            ...
            case LOANPAIDID:
                ...
                sqlBuilder.setTables(DBContract.LoanPaid.LOANPAYMENT_TABLE);
                sqlBuilder.appendWhere(DBContract.LoanPaid._ID + " = " + uri.getPathSegments().get(1));
                cursor = sqlBuilder.query(db, projection, selection, selectionArgs, sortOrder, null, null, null);
                cursor.setNotificationUri(getContext().getContentResolver(), uri);
