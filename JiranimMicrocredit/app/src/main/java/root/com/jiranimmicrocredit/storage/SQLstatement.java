...
public class SQLstatement {
    ...
    public static final String LoanApplicationSQL="CREATE TABLE " + DBContract.LoanApplication.LOANAPPLICATION_TABLE + "  ( "+
            ...
            DBContract.LoanApplication.KEY_INSTALLMENT+ " int(5) NULL," +
            DBContract.LoanApplication.KEY_PAYMENTDURATION+ " int(5) NULL," +
            DBContract.LoanApplication.KEY_PURPOSE + " varchar(250) NULL," +
            DBContract.LoanApplication.KEY_TIMEADDED + " varchar(250) NULL" +
            ");";

     public static final String LoanPaymentSQL="CREATE TABLE " + DBContract.LoanPaid.LOANPAYMENT_TABLE + "  ( "+
                DBContract.LoanPaid._ID + " INTEGER PRIMARY KEY ," +
                DBContract.LoanPaid.KEY_IDLOANAPPLICATION + " int(5) NULL," +
                DBContract.LoanPaid.KEY_AMOUNTPAID + " int(5) NULL," +

                DBContract.LoanPaid.KEY_STATUS+ " int(5) NULL," +
                DBContract.LoanPaid.KEY_TIMEADDED + " varchar(250) NULL" +
                ");";
