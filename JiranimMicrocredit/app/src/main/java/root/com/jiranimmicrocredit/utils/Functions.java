...
public class Functions {
    ...
    public ContentValues getpaymentLoans(int id){

        ContentValues values=new ContentValues();
        values.put(Constants.ACTION,Constants.ACTION_QUERY);
        values.put(Constants.USERACTION,Constants.USERACTION_LOANPAYMENT);
        values.put(Constants.PARAM_ID_APPLICANT,id);
        return values;
    ...
    public ContentValues profile(int id,String fname,String lname,String sname,String phone,String email,String idnumber,String password,String imei,String avatar){
        ContentValues values=new ContentValues();
        ...
        values.put(Constants.PARAM_IMEI,imei);
    ...
    public ContentValues loanApplication(int id_loanapplication,int id_applicant,int loanAmount,String macaddress,String purpose){
        ContentValues values=new ContentValues();
        ...
        values.put(Constants.PARAM_MACADRESS,macaddress);
    ...
    public ContentValues gurantors(int id,String fname,String lname,String sname,String phone,String email,String idnumber,String idapplicant,String residence,String avatar){
        ContentValues values=new ContentValues();
        values.put(Constants.ACTION,Constants.ACTION_GURANTORS);
    ...
    public ContentValues otherOcupation(int id,String occupationname,String income,String otherDescription,String idapplicant,String avatar){
        ContentValues values=new ContentValues();
        values.put(Constants.ACTION,Constants.ACTION_OTHEROCCUPATION);
