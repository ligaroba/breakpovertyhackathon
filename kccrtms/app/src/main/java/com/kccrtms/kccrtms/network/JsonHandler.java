...
public class JsonHandler {
    ...
    private String requestUrl="http://192.168.43.247/kccrtms/implementation.php";
   // private String requestUrl="http://197.254.45.90:82/kccrtms/implementation.php";
    // 192.168.43.247
    ...
    public JSONObject JsonConnection(ContentValues postDataParams) throws IOException {
        ...
        if (responsCode == HttpURLConnection.HTTP_OK) {
            ...
            return jsonobject;
             ...
             Log.e(TAG, conn.getErrorStream().toString());
            return null;
        }
